		...
		<view  style="background-color: #ffffff;flex-shrink: 0;display: flex;flex-direction: column;" :style="{height:height.shang+'px'}">
			...
			<view style="display: flex;flex-direction: row-reverse;width: 100%;height: 30px;align-items: center;">
				<view style="width: 85%;display: flex;flex-direction: row-reverse;height: 30px;align-items: center;" >
					<view v-if="is_zuoda" @click="tijiao()" style="margin-right: 20rpx;background-color: #ff7599;height: 30px;width: 50px;border-radius: 10upx;text-align: center;">
						<text>提交</text>
					</view>
					<view v-else @click="close_pop()" style="margin-right: 20rpx;background-color: #ff7599;height: 30px;width: 50px;border-radius: 10upx;text-align: center;">
						<text>离开</text>
					</view>
				...
				<view>
					<!-- <text v-if="now_dian.pos!==-1" style="color: red;" @click="del()">删除</text> -->
			...
			<view style="display: flex;flex-direction: row;align-items: center;padding: 0px 15px 0px 15px;">
				...
				<view style="height: 116.33px;position: fixed;" v-if="show_ans">
		...
		<uni-popup ref="result" :mask-click="false">
			<view style="background-color: #ffffff;border-radius: 20upx;display: flex;flex-direction: column;z-index: 99;" :style="{width:width.pop+'px',height:height.pop+'px'}">
				<view style="display: flex;flex-direction: column;background-color: #62b8af;color: #ffffff;" :style="{height:height.pop*0.8+'px'}">
					...
					<view style="display: flex;flex-direction: row;">
						<text style="width: 20%;margin-left: 10%;">正确率:</text>
						<text>{{finall_res.zhengque_per.toFixed(2)}}%</text>
					</view>
					<view style="display: flex;flex-direction: row;">
						<text style="width: 20%;margin-left: 10%;">正确个数:</text>
						<text>{{finall_res.right}}</text>
					</view>
					<view style="display: flex;flex-direction: row;">
						<text style="width: 20%;margin-left: 10%;">错误个数:</text>
						<text>{{finall_res.wrong}}</text>
					</view>
					<view style="display: flex;flex-direction: row;">
						<text style="width: 20%;margin-left: 10%;">用时:</text>
