<template>
	<view class="uni-searchbar" >
		<image src="../../../../static/search/sousuo2.png"style="width: 50px; height: 45px;float: left;"></image>
		...
		<image src="../../../../static/search/sousuo1.png"style="width: 50px; height: 45px;float:right"></image>
	</view>
</template>
