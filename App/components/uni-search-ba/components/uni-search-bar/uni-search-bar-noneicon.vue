<template>
	<view class="uni-searchbar" >
			<!-- <image src="../../../../static/sousuo2.jpg"style="width: 50px; height: 45px; background-color: #eeeeee;float: left;"></image> -->
		<view :style="{borderRadius:radius+'px',backgroundColor: bgColor}" class="uni-searchbar__box" @click="searchClick">
			
			<view class="uni-searchbar__box-icon-search">
				<slot name="searchIcon">
					<uni-icons color="#626468" size="18" type="search" />
				</slot>
			</view>
		...
		<!-- <image src="../../../../static/sousuo1.png"style="width: 50px; height: 45px; background-color: #eeeeee;float:right"></image> -->
	</view>
</template>
